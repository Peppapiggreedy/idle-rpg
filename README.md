...
| быстрый набор | `test` | 49 с | на каждой правке |
| прибор веток | `test:branches` | 222 с | после правки дерева талантов |
| проба баланса | `test:balance:sample` | 1198 с (20 мин) | после правки чисел баланса |
| полная матрица | `test:balance` | 2473 с (41 мин) | один раз перед PR |
