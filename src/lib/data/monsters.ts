...
export const MONSTER_BASE = {
  ...
  // 18, а не прежние 2.6. Число держит КОНТРАКТ ЦЕНЫ БОЯ (CLAUDE.md): герой в
  // актуальном снаряжении теряет 20-25% здоровья за бой с медианным мобом
  // своей зоны. При 2.6 он не терял НИЧЕГО — реген в бою обгонял входящий
  // урон на всех уровнях, и баланс HP за бой был отрицательным (герой лечился
  // по ходу схватки). Замер до правки — в описании PR.
  damage: new Decimal(18),
