...
export const MONSTER_BASE = {
  ...
  // 15.3 — это 18 минус пятнадцать процентов. Число держит КОНТРАКТ ЦЕНЫ БОЯ
  // (CLAUDE.md): герой в актуальном снаряжении теряет 17-21% здоровья за бой
  // с медианным мобом своей зоны.
  //
  ...
  // лечился. 18 давало 20-25%, и по живой игре это оказалось жестковато;
  // пятнадцать процентов сняты по решению владельца.
  damage: new Decimal(15.3),
