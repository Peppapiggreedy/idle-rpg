...
export const RARITIES: RarityDef[] = [
  ...
  { id: 'uncommon',  name: 'Необычный',    weight: 40,  color: '#4caf50', sound: 'loot-uncommon',  reveal: false, bonusMult: new Decimal(2),  sellMult: new Decimal(2) },
  { id: 'rare',      name: 'Редкий',       weight: 15,  color: '#2196f3', sound: 'loot-rare',      reveal: false, bonusMult: new Decimal(4),  sellMult: new Decimal(5) },
  { id: 'epic',      name: 'Эпический',    weight: 4,   color: '#9c27b0', sound: 'loot-epic',      reveal: true,  bonusMult: new Decimal(8),  sellMult: new Decimal(12) },
  { id: 'legendary', name: 'Легендарный',  weight: 1,   color: '#ff9800', sound: 'loot-legendary', reveal: true,  bonusMult: new Decimal(16), sellMult: new Decimal(30) },
]
