...
export const CLASSES: ClassDef[] = [
  ...
  },
  {
    ...
    // ВТОРОЕ ПОКОЛЕНИЕ: ночь ярости переставила запас на шкалу 0..100 и
    // пересобрала все три ветки. Для игрока это ОДНО событие — «дерево стало
    // другим», — поэтому и номер один на всю ночь, а не по номеру на стадию.
    treeRevision: 2,
    baseMods: [
