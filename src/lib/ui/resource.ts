...
export interface ResourceWords {
  ...
  fromCombat: boolean
  /** Тон полоски: у каждого рода ресурса свой цвет — они и ведут себя иначе. */
  tone: 'mana' | 'rage' | 'energy'
}
...
const WORDS: Record<string, Pick<ResourceWords, 'name' | 'genitive' | 'accusative' | 'tone'>> = {
  ...
  energy: { name: 'Энергия', genitive: 'энергии', accusative: 'энергию', tone: 'energy' },
}
