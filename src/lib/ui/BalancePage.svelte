...
<main>
  ...
  {#if pacingRows.length > 0}
    <h2>Темп боя</h2>
    <p class="note">
      Эталонное прохождение: герой в средней по рулетке экипировке уровня
      своей зоны, переезд и переодевание по мере открытия. В клетке —
  ...
  {#if zoneRows.length > 0}
    <h2>Зоны</h2>
    <p class="note">
      Эталонный герой {BALANCE_PRESET.zoneLevel} уровня в средней по рулетке
      экипировке уровня своей зоны. Автокаст включён, уровень растёт по ходу
      прогона, как в живой игре.
    </p>
    <div class="scroll">
      <table>
        <thead>
