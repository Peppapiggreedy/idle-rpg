 ...
 * Полтора: замер даёт 1.29 на самой дорогой полосе, и запас оставлен под
 * обычный разброс, а не под провал. Провал — это когда полоса стоит вдвое
 * дороже своей ширины, и он этим порогом ловится.
 */
const BAND_SHARE_MAX = 1.5
