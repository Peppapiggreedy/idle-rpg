...
export type DecisionKind =
  ...
  | 'enchant'
  // Вход в храм — решение игрока: попытка одна в сутки, и потратить её
  // не думая нельзя.
  | 'temple'
  // Разбор добычи: покупка за золото и переключатель «что делать с лишним».
  // Такое же решение, как надевание, — игрок говорит игре, что делать с
  // находками, и от этого меняется, что доходит до его сумки.
  | 'inventory-policy'
