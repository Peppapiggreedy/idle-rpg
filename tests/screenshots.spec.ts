...
//      интерфейс. (Прежняя трёхмерная сцена не сравнивалась никогда: WebGL
//      в headless-браузере идёт через программный растеризатор, и та же
//      сборка на другой машине давала другие пиксели.)
//
...
// там герой в снаряжении и числа урона не однозначные. Эти эталоны — замок
// на удаление прежнего трёхмерного слоя: пока они зелёные, сцена цела.
