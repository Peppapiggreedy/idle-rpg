...
//
// ПРЕСЕТЫ ЗДЕСЬ — ТЕ ЖЕ, ЧТО У СТРАНИЦ, и это не «на всякий случай». Список
// был короче на `mid`, и ровно на нём числа уехали молча: эталон показывал
// здоровье 186 из 345, игра — 207, и обе полностраничных проверки пресета
// проходили, потому что три цифры не добирают до порога 0.001. Нашлось это
// случайно — правка отступов сцены добавила своих пикселей, и сумма наконец
// перевалила порог. Сторож с дыркой ровно в один пресет — это сторож, о
// котором думают, что он сторожит.
const NUMERIC_PRESETS = PRESETS
