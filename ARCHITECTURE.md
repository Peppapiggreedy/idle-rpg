...
**Чего в слое нет.** Моделей: сцена собрана на примитивах, GLB-паков в игре
нет. `three` грузится динамическим импортом отдельным чанком, поэтому в
текстовом режиме и без WebGL не скачивается вовсе.
